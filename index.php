...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="EVA merupakan Layanan Pembuatan Chatbot secara Instan di berbagai Platform Messaging. Tanpa harus memiliki Keahlian Programming, dan Pengelolaannya yang Mudah.">

    <!-- OG Meta Tags to improve the way the post looks when you share the page on LinkedIn, Facebook, Google+ -->
    <meta property="og:site_name" content="Eva Whatsapp Bot Creator"> <!-- website name -->
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div style="width: 100vw">
            ...
            <div class="container p-lg-5">
                <div class="row p-lg-5 my-lg-5 my-sm-0">
                    ...
                    <div class="col-lg-6 hidden-md-down">
                        <div class="image-container h-100 d-flex flex-column justify-content-center">
                            <img class="img-fluid" src="asset/images/eva_1.png" alt="alternative">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="basic-1 bg-diag-left">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container hidden-md-down">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="asset/img/main/Group 142.png" alternative="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="basic-1 bg-diag-right">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <img src="asset/img/main/Group 232.png" style="max-width: 100%">
                    </div>
                    <div class="col-lg-6">
                        <div class="image-container">
                            ...
                            <div class="text-right hidden-md-down">
                                <p class="ml-5">
                                    Whatsapp Bot bisa menjadi perantara percakapan langsung antara Customer Service dengan Konsumen.
                                </p>
                            </div>
        ...
        <div class="basic-1 bg-diag-left">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="asset/img/main/Group 241.png" style="max-width: 100%">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mx-md-5 mx-sm-0">
                <div class="row mx-5">
                                ...
                                <div class="card" style="height: 100%">
                                    ...
                                    <div class="card-body d-flex justify-content-center align-items-center" style="border: 1px solid #1EBEA5;">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">More User Admin/Operator <i class="fas fa-check text-success"></i></li>
                                            <li class="list-group-item">WA Broadcast Rp.490/Push <i class="fas fa-check text-success"></i></li>
                                            <li class="list-group-item">Registrasi WA Verified <i class="fas fa-check text-success"></i></li>
                                            <li class="list-group-item">Ticket LiveChat <i class="fas fa-check text-success"></i></li>
                                            <li class="list-group-item">Dashboard Management <i class="fas fa-check text-success"></i></li>
                    ...
                    <div class="col-12 text-center mt-5">
                        <div>
                            Sudah Dipercaya oleh 15+ perusahaan besar
                            <div class="mt-2">
                                <img src="asset/img/main/ITB.png" style="max-width: 100%">
                                <img src="asset/img/main/Sasa.png" style="max-width: 100%">
                                <img src="asset/img/main/Taspen.png" style="max-width: 100%">
                                <img src="asset/img/main/Kemnaker.png" style="max-width: 100%">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="hidden-md-down">
                            <p>
                                </p><h1 class="text-white">Mulai menggunakan Whatsapp Bot Sekarang !</h1>
                            <p></p>
                            <p>
                                </p><h5 class="text-white">Daftar dengan instan, Gratis dan Mudah hanya di EVA.id</h5>
                            <p></p>
                        </div>
